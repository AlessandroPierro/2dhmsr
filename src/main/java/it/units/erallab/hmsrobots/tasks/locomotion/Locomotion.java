...
public class Locomotion extends AbstractTask<Robot, Outcome> {
    ...
    public Locomotion(Predicate<Map<Double, Outcome.Observation>> stoppingCriterion, double[][] groundProfile, Settings settings) {
        super(settings);
    ...
    public Locomotion(Predicate<Map<Double, Outcome.Observation>> stoppingCriterion, double[][] groundProfile, double initialPlacement, Settings settings) {
        super(settings);
        this.stoppingCriterion = stoppingCriterion;
        this.groundProfile = groundProfile;
        this.initialPlacement = initialPlacement;
